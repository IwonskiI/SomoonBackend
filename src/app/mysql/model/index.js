...
db.remodeling_apply = require("./remodeling_apply.js")(
  sequelizeConfig,
  Sequelize
);
...
db.specialized = require("./SPECIALIZED")(sequelizeConfig, Sequelize);
db.company_abilities = require("./COMPANY_ABILITIES")(
  sequelizeConfig,
  Sequelize
);
db.review_img = require("./review_img.js")(sequelizeConfig, Sequelize);

// 관계 설정
db.review.belongsTo(db.remodeling_apply, {
  foreignKey: "remodeling_apply_id",
  target: "remodeling_apply_id",
});
db.remodeling_apply.hasOne(db.review, {
  foreignKey: "id",
  target: "remodeling_apply_id",
});
...
db.remodeling.hasMany(db.remodeling_img, {
  foreignKey: "remodeling_id",
  source: "id",
});
db.remodeling_img.belongsTo(db.remodeling, {
  foreignKey: "remodeling_id",
  target: "id",
});

db.company.hasMany(db.specialized, { foreignKey: "Company_num", source: "id" });
db.specialized.belongsTo(db.company, {
  foreignKey: "Company_num",
  target: "id",
});

db.company_abilities.hasOne(db.specialized, {
  foreignKey: "Ability_num",
  source: "Id",
});
db.specialized.belongsTo(db.company_abilities, {
  foreignKey: "Ability_num",
  target: "Id",
});

db.review.hasMany(db.review_img, { foreignKey: "review_id", source: "id" });
db.review_img.belongsTo(db.review, { foreignKey: "review_id", target: "id" });
